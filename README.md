...
11. If the pico is plugged into a computer via USB while running it will appear as a COM port and basic diagnostic messages can be viewed at 115200 baud.  If you set d_enable_all_debugging_messages on line 28 in main.c then additionally raw $GNRMC or $GPRMC messages from GPS unit will be displayed, and every 20 seconds decoded latitude/longitude and grid locator will be shown.
