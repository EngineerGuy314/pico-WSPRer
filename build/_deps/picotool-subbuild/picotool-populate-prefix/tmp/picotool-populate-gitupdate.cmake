...
execute_process(
  COMMAND "/usr/bin/git" show-ref "2.0.0"
  WORKING_DIRECTORY "/home/rob/pico-WSPRer/build/_deps/picotool-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/2.0.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "2.0.0")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/raspberrypi/picotool.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/rob/pico-WSPRer/build/_deps/picotool-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/rob/pico-WSPRer/build/_deps/picotool-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
